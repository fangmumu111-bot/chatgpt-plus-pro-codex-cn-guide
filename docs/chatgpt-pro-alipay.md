...
2. 按真实工作量核对 5x 新开通；20x 只按当前续费条件办理，原付款非 App Store / Google Play 且未到期或到期后仍显示 20x，先确认再下单。
...
没有脱离工作量的统一答案。个人高频但非全天重度先比较 5x；单人全天多项目、5x 仍持续不足时可比较 20x 用量，但新购和升级当前暂停；已有 20x 先核对续费条件。若使用限制没有影响真实交付，继续 Plus 更合理。
