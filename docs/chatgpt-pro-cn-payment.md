...
4. 下单前按上方状态表确认 5x 新开或 20x 续费资格；20x 还要核对原付款渠道，不把 Plus、API 余额或共享账号当作同一商品。
5. 使用支付宝或结账页实时显示的 USDT 网络付款时，核对金额、链名称和订单状态，不要重复付款。
6. 付款后通过订单页查看处理状态；人工订单需要等待时，以页面状态和售后说明为准。

## Pro 5x 和 20x 怎么选

ChatGPT Pro 5x 对应 100 美元档（中文也常写“100 美金 Pro”），Pro 20x 对应 200 美元档（“200 美金 Pro”）。两档包含相同的核心 Pro 能力，主要区别是使用额度；部分模型或功能可能另有独立限制。个人高频但并非全天重度，先比较 5x；单人全天多项目、密集长任务且 5x 仍持续不足，可比较 20x 的用量，但当前不能新购或升级至 20x；已有 20x 按状态表核对续费。
