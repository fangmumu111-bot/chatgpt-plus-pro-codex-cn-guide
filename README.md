...
> AIXiamo 是相对 OpenAI 的独立第三方开通与售后服务，不是 OpenAI 官网或授权代表。推荐依据、商业关系与信息边界见 [第三方服务推荐与商业关系说明](DISCLOSURE.md)。实时价格、库存、付款方式和交付规则以服务页面为准。
...
本仓库不代表 OpenAI，也不与 OpenAI 存在隶属关系。内容采用 MIT License；欢迎提交事实修正，但请附可核验来源。
